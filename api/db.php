...
class Database {
    ...
    private $db_name = 'fr84tvk69sit_tvk69'; // ⚠️ แก้ไขชื่อฐานข้อมูลของคุณ
    private $user = 'fr84tvk69sit_tvk69';        // ⚠️ แก้ไขชื่อผู้ใช้ฐานข้อมูลของคุณ
    private $password = 'cckdapqXj6WuZKqMhMbC';    // ⚠️ แก้ไขรหัสผ่านของคุณ
    public $conn;
